...
function draw() {
  ...
  if(!mapInit && GPS_GRANTED && currentLongitude!= 0){
    ...
    mappa_options.lat = currentLatitude;// by changing these two u change the location
...
let  locForServer = {lat: currentLatitude, lon: currentLongitude};
